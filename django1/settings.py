...
SECRET_KEY = 'django-insecure-t)1%r#(%=w-7dqx!plms&)d39uy@q7w+h^$ib6s-dn%n@tenr7'
...
#Para recuperar os arquivos estáticos devemos rodar o seguinte comando no terminal:
